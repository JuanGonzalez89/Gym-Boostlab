...
def altaCliente(personas):
    ...
    while True:
        estado = input("Ingrese el estado del cliente (Activo o Inactivo): ").lower()
        if estado in ["activo", "inactivo"]:
            break
        else:
            print("Estado no válido. Por favor, ingrese 'Activo' o 'Inactivo'")
    while True:
        membresia = input("Ingrese el estado de la membresia (Paga, Pendiente, Inpaga): ").lower()
        if membresia in ["paga","pendiente","inpaga"]:
            break
        else:
            print("Membresia no válida. Por favor, ingrese Paga, Pendiente o Inpaga")
    

    while True:
        objetivo = input("Ingrese el objetivo (Aumentar masa muscular, Disminuir grasa corporal, Mantener estado fisico): ").strip().lower()
        if objetivo in ["aumentar masa muscular", "disminuir grasa corporal", "mantener estado fisico"]:
            break
        else:
            print("Objetivo no válido. Debe ser uno de los siguientes: Aumentar masa muscular, Disminuir grasa corporal, Mantener estado físico.")

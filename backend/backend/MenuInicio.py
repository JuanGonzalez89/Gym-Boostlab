...
def InformeMembresiaClientes(personas):
    ...
    for cliente in personas:
        ...
        print(f"Nombre: {nombre}, Estado: {estado}")
    
    print("---------------------------")
    input("Presione ENTER para volver al menú.")
    Dieta
def AsignarRutina(personas, rutinas):  
    ...
def AsignarDieta(personas,dietas):
    
    for personas in personas:
        Objetivo=personas['objetivo']
        if objetivo == "Disminuir grasa corporal":
            personas['objetivo']= random.randint(1,10)
            
        elif objetivo == "Mantener estado físico" :
            personas['objetivo']= random.randint(11,20)
            
        elif objetivo == "Aumentar masa muscular" :
            personas['objetivo'] = random.randint(21,30)
            ...
            if OpcionMenuGestionClientes=="1":
               ...
               inactivarClientes(personas)
                ...
                if OpcionMenuGestionRutinas=="1":
                    ...
                    AsignarRutina(rutinas,personas)
